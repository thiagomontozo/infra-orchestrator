...
func Permission(provider, action string) string {
	prefix := "service"
	switch provider {
	case "docker", "dockercompose", "podman", "podmancompose":
		prefix = "container"
	case "kubernetes":
		prefix = "kubernetes"
	case "nomad":
